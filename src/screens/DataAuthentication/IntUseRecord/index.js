...
@navigatorDecorator
class IntUseRecord extends Component {
    constructor(props) {
        super(props);
        this.state = {
            publishState: [''],
    ...
    navigationButtonPressed() {
        this.pushPage({
            component: {
                ...
                ...Global.Screens.IntUseRecordAdd,
            }
        });
    }
                            ...
                            <TouchableWithoutFeedback activeOpacity={0.3} underlayColor={'#eee'}
                                onPress={() => {
                                    this.pushPage({
                                        component: {
                                            ...
                                            ...Global.Screens.IntUseRecordDetail,
                                        }
                                    });
                                }}>
                                <View style={{ borderBottomColor: '#e3e3e3', borderBottomWidth: 1, paddingLeft: 12, paddingRight: 12, paddingTop: 10 }}>
                                    ...
                                    <View style={{ justifyContent: 'space-between', flexDirection: 'row' }}>
                                        ...
                                        <Text style={{ color: '#49a9ee', lineHeight: 30, }}>{item.useDateStr}</Text>
                                    </View>
                                    <WhiteSpace />
                                </View>
                            </TouchableWithoutFeedback>
...
module.exports = connect(mapStateToProps)(IntUseRecord);
