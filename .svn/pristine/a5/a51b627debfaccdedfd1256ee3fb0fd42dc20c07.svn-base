    ...
    navigationButtonPressed() {
        this.pushPage({
            component: {
                ...
                ...Global.Screens.ProductRecoveryAdd,
            }
        });
    }
        ...
        return (
            <View style={styles.container}>
                ...
                <LoadMoreList
                    ...
                    getData={MineAction.ListProductRecovery}
                        ...
                        return <SwipeAction autoClose style={{ backgroundColor: 'transparent', flex: 1 }} right={[
                                ...
                                onPress: () => {
                                    Alert.alert(
                                        ...
                                        },
                                        {
                                            text: '确定',
                                            onPress: () => {
                                                MineAction.DeleteProductRecovery({
                                                    idList: [
                                                        item.id + ''
                                                    ]
                                                }).then((data) => {
                            ...
                            <TouchableWithoutFeedback activeOpacity={0.3} underlayColor={'#eee'}
                                onPress={() => {
                                    this.pushPage({
                                        component: {
                                            ...
                                            ...Global.Screens.ProductRecoveryDetail,
                                        }
                                    });
                                }}>
                                <View style={{ borderBottomColor: '#e3e3e3', borderBottomWidth: 1, paddingLeft: 12, paddingRight: 12, paddingTop: 10 }}>
                                    ...
                                    <WhiteSpace />
                                    <View style={{ justifyContent: 'space-between', flexDirection: 'row' }}>
                                        <Text style={{ color: '#49a9ee', lineHeight: 30, }}>采收时间：{item.pickDay} </Text>
                                        <Text style={{ color: '#49a9ee', lineHeight: 30, }}>种植时间：{item.createTime}</Text>
                                    </View>
                                    <WhiteSpace />
                                </View>
                            </TouchableWithoutFeedback>
...
module.exports = connect(mapStateToProps)(ProductRecovery);
