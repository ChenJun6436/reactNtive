        ...
        return (
            <View style={styles.container}>
                ...
                <LoadMoreList
                    ...
                    getData={MineAction.ListProductSale}
                                ...
                                onPress={() => {
                                    this.pushPage({
                                        component: {
                                            ...
                                            ...Global.Screens.ProductSaleDetail,
                                        }
                                    });
                                }}>
...
module.exports = connect(mapStateToProps)(ProductSale);
